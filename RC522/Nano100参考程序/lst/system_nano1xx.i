...
#line 14 "Libraries\\system_nano1xx.c"
#line 1 ".\\Include\\nano1xx.h"
...
#line 15 "Libraries\\system_nano1xx.c"
...
void SetSystemClock(void)
{
  ...
  ((CLK_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00200))->PWRCTL |= ((uint32_t)0x00000001);
  ...
  (((GCR_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00000))->PA_H_MFP = ((GCR_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00000))->PA_H_MFP &~(((uint32_t)0x70000000)|((uint32_t)0x07000000)) | (((uint32_t)0x60000000)|((uint32_t)0x06000000)));
  
  ((CLK_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00200))->APBCLK |= ((uint32_t)0x00010000);                          
  ((CLK_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00200))->CLKDIV0 &= ~((uint32_t)0x00000F00);



  ((CLK_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00200))->CLKSEL1 = (((CLK_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00200))->CLKSEL1 & ~((uint32_t)0x00000003)) | ((uint32_t)0x00000000);   


  ((UART_TypeDef *) ((0x40000000UL) + 0x50000))->BAUD = 0x67;               
  ((UART_TypeDef *) ((0x40000000UL) + 0x50000))->TLCTL = 0x03;              

}

void SystemCoreClockUpdate (void)             
{
  SystemCoreClock = (1*(12000000UL));
}

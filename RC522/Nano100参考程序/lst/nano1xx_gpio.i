...
void GPIO_EnableInt(GPIO_TypeDef *port, uint32_t bit, uint32_t TriggerType, uint32_t Mode)
{
	...
	if ((port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04000))) || (port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04040))) || (port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04080))))
	{
		
		NVIC_EnableIRQ(GPABC_IRQn);
	}

	if ((port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x040C0))) || (port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04100))) || (port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04140))))
	{

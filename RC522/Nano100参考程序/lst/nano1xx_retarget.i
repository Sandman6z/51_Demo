...
void SendChar_ToUART(int ch)
{
	if(0 == 1)
	{
	    while(((UART_TypeDef *) (((0x40000000UL) + 0x100000) + 0x50000))->FSR & ((uint32_t)0x00000400));
		((UART_TypeDef *) (((0x40000000UL) + 0x100000) + 0x50000))->THR = ch;
	    if(ch == '\n'){
	        while(((UART_TypeDef *) (((0x40000000UL) + 0x100000) + 0x50000))->FSR & ((uint32_t)0x00000400));
	        ((UART_TypeDef *) (((0x40000000UL) + 0x100000) + 0x50000))->THR = '\r';
	    }
	}
	else if(0 == 0)
	{
		while(((UART_TypeDef *) ((0x40000000UL) + 0x50000))->FSR & ((uint32_t)0x00000400));
		((UART_TypeDef *) ((0x40000000UL) + 0x50000))->THR = ch;
	    if(ch == '\n'){
	        while(((UART_TypeDef *) ((0x40000000UL) + 0x50000))->FSR & ((uint32_t)0x00000400));
	        ((UART_TypeDef *) ((0x40000000UL) + 0x50000))->THR = '\r';
	    }
	}
	else 
		;
...
#line 123 "Libraries\\nano1xx_retarget.c"
	...
	{
		while (1){
			if((((UART_TypeDef *) (((0x40000000UL) + 0x100000) + 0x50000))->FSR & ((uint32_t)0x00000002)) == 0 )
			{
				return (((UART_TypeDef *) (((0x40000000UL) + 0x100000) + 0x50000))->RBR);
	...
	{
		while (1){
			if((((UART_TypeDef *) ((0x40000000UL) + 0x50000))->FSR & ((uint32_t)0x00000002)) == 0 )
			{
				return (((UART_TypeDef *) ((0x40000000UL) + 0x50000))->RBR);
...
int kbhit(void)
{
    ...
    if (((UART_TypeDef *) ((0x40000000UL) + 0x50000))->FSR & ((uint32_t)0x00000002))
	    return 0;
	else
		return 1;
#line 170 "Libraries\\nano1xx_retarget.c"
...
int IsDebugFifoEmpty(void)
{
    ...
    if (((UART_TypeDef *) ((0x40000000UL) + 0x50000))->FSR & ((uint32_t)0x00000800))
	   return 1;
	else
		return 0;
#line 192 "Libraries\\nano1xx_retarget.c"
